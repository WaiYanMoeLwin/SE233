package se233.chapter5_1.model;

import javafx.scene.image.Image;
import javafx.scene.input.KeyCode;
import javafx.scene.layout.Pane;
import se233.chapter5_1.Launcher;
...
public class GameCharacter extends Pane {
    ...
    public void respawn() {
        this.x = this.startX;
        this.y = this.startY;
        this.imageView.setFitWidth((int) (this.characterWidth * 1.2));
        this.imageView.setFitHeight((int) (this.characterHeight * 1.2));
